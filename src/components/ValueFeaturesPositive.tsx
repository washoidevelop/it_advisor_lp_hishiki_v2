  ...
  return (
    <div className="bg-white pt-12 pb-6 md:py-[60px]">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
        <div className="bg-green-700 rounded-2xl p-6 sm:p-8 md:p-12">
          ...
          <p className="text-white text-sm sm:text-[15px] mb-8 sm:mb-12">
            「嬉しい、楽しい、安心」が生まれます。<br />
            効率化されるのはもちろん、感情への効果も上乗せされ、会社全体が活性化します。<br />
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            <div className="bg-white p-6 sm:p-8 rounded-lg">
              ...
              <p className="text-sm text-[#0E3A51] leading-relaxed">
                「あれ、今まで何時間もかかっていた作業が、たった数分で!?」と目を疑うレベルのスピード感に、チーム全体が高揚感を味わう。
              </p>
              <img
            ...
            <div className="bg-white p-6 sm:p-8 rounded-lg">
              ...
              <p className="text-sm text-[#0E3A51] leading-relaxed">
                「私たちはAIを使いこなしている先進企業だ」という自信が生まれる。自信が顧客にも伝わる。
              </p>
              <img
            ...
            <div className="bg-white p-6 sm:p-8 rounded-lg">
              ...
              <p className="text-sm text-[#0E3A51] leading-relaxed">
                効果が出るか分からない、内容が分からないシステム開発に高額な費用を払うリスクがなくなる。
              </p>
              <img
